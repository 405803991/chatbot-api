package stu.xjtu.chatbot.api.domain.zsxq.service;
...
import stu.xjtu.chatbot.api.domain.zsxq.model.req.AnswerReq;
import stu.xjtu.chatbot.api.domain.zsxq.model.req.ReqData;
import stu.xjtu.chatbot.api.domain.zsxq.model.res.AnswerRes;

import java.io.IOException;

public class ZsxqApi implements stu.xjtu.chatbot.api.domain.zsxq.ZsxqApi {
